...
class TestMultiLevelBucketFieldRaw(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MultiLevelBucketFieldRaw:
        """Test MultiLevelBucketFieldRaw
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MultiLevelBucketFieldRaw`
        """
        model = MultiLevelBucketFieldRaw()
        if include_optional:
    ...
    def testMultiLevelBucketFieldRaw(self):
        """Test MultiLevelBucketFieldRaw"""
