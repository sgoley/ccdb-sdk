...
class TestAggregationField(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AggregationField:
        """Test AggregationField
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AggregationField`
        """
        model = AggregationField()
        if include_optional:
