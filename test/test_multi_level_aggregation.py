...
class TestMultiLevelAggregation(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MultiLevelAggregation:
        """Test MultiLevelAggregation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MultiLevelAggregation`
        """
        model = MultiLevelAggregation()
        if include_optional:
    ...
    def testMultiLevelAggregation(self):
        """Test MultiLevelAggregation"""
