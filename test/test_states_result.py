...
class TestStatesResult(unittest.TestCase):
    """StatesResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StatesResult:
        """Test StatesResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StatesResult`
        """
        model = StatesResult()
        if include_optional:
            return StatesResult(
                aggregations = openapi_client.models.states_result_aggregations.StatesResult_aggregations(
