...
class MultiLevelBucketFieldRaw(BaseModel):
    """
    The next level of aggregations
    """ # noqa: E501
    buckets: Optional[List[Aggregation]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "buckets": [Aggregation.from_dict(_item) for _item in obj["buckets"]] if obj.get("buckets") is not None else None
        })
        return _obj
