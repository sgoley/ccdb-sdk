...
class Hits(BaseModel):
    ...
    max_score: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The highest score in the results")
    total: Optional[HitsTotal] = None
    __properties: ClassVar[List[str]] = ["hits", "max_score", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "total": HitsTotal.from_dict(obj["total"]) if obj.get("total") is not None else None
        })
        return _obj
