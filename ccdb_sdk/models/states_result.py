...
class StatesResult(BaseModel):
    ...
    StatesResult
    """ # noqa: E501
    aggregations: Optional[StatesResultAggregations] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "aggregations": StatesResultAggregations.from_dict(obj["aggregations"]) if obj.get("aggregations") is not None else None
        })
        return _obj
