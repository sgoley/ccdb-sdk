...
class StatesResultAggregations(BaseModel):
    """
    StatesResultAggregations
    """ # noqa: E501
    issue: Optional[MultiLevelAggregation] = None
    product: Optional[MultiLevelAggregation] = None
    state: Optional[MultiLevelAggregation] = None
    __properties: ClassVar[List[str]] = ["issue", "product", "state"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "state": MultiLevelAggregation.from_dict(obj["state"]) if obj.get("state") is not None else None
        })
        return _obj
