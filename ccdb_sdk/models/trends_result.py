...
class TrendsResult(BaseModel):
    ...
    TrendsResult
    """ # noqa: E501
    aggregations: Optional[TrendsResultAggregations] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "aggregations": TrendsResultAggregations.from_dict(obj["aggregations"]) if obj.get("aggregations") is not None else None
        })
        return _obj
