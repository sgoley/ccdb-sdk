...
class Hit(BaseModel):
    ...
    """ # noqa: E501
    source: Optional[Complaint] = Field(default=None, alias="_source")
    __properties: ClassVar[List[str]] = ["_source"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "_source": Complaint.from_dict(obj["_source"]) if obj.get("_source") is not None else None
        })
        return _obj
